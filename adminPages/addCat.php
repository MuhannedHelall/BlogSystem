        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="addCat.php">
                                <span data-feather="file" class="align-text-bottom"></span>
                                Add a category
                            </a>
                        </li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form method="POST" class="p-5 my-2">
                    <input type="text" name="name" class="d-block w-100 py-3 px-3 my-2 rounded border border-1 bg-light" placeholder="Name" required />
                    <button class="w-100 btn btn-lg btn-primary mt-2" type="submit" id="create">Add a category</button>
                </form>
