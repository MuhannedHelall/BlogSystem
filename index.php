        ...
        <section class="py-5 text-center container">
            <div class="row pt-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <h1 class="fw-light">Muhanned's Blog</h1>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    ?>
                        <div class="col">
                            <a href="viewPost.php?id=<?= $post['id'] ?>" class="text-decoration-none text-dark">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <small class="d-flex justify-content-end text-muted"><?= $post['category'] ?></small>
                                    </div>
                                </div>
                            </a>
                        </div>
